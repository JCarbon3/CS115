...
7       halt
"""
#Fibonacci is a program that asks the user for a number n then
#prints the first n values of the Fibonacci sequence.

Fibonacci = """
#Input: n
#Assume: n >= 0
#Output: n values of fibonacci

#register usage: r1 for the input, r13 for the output

0       read    r1         # Get n
1       setn    r2 0       # initialize r2
2       setn    r3 1       # initialize r3
3       jeqzn   r1 12      # done if r1 is 0
4       write   r2         # print r2
5       add     r2 r2 r3   # increment r2 using r3
6       addn    r1 -1      # decrement r1 by 1
7       jeqzn   r1 12      # done if r1 is 0
8       write   r3         # write r3
9       add     r3 r2 r3   # increment r3 using r2
10      addn    r1 -1      # decrement r1 by 1
11      jumpn   3          # jump to line 3
12      halt               # stop
"""
